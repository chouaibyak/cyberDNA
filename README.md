...
Le dashboard React est exposé sur le port `5173`. Une fois les conteneurs
démarrés, ouvrez **http://localhost:5173** dans le navigateur.

`http://localhost` seul correspond au honeypot Honeytrap, qui utilise le port
80 ; ce n'est pas l'adresse du dashboard.

Pour vérifier son démarrage :
